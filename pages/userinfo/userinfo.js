Page({
  ...
  previewImg(e){  //预览图片
    ...
    var imgArr = [];
    for (let index in this.data.swiperList){
      imgArr[index] = this.data.swiperList[index].url
    }
    wx.previewImage({
  ...
  like(){ //点击我的喜欢
    if(this.data.like.selectStatus ==true){
      this.setData({
        like: {
          class: 'bg-white',  //默认的
          selectStatus: false
